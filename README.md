This repo contains a solver for the IQ twist puzzle game [1]. The solver has been compiled to webassembly, and a very simple front-end has been made for generating and visualizing solutions. 
